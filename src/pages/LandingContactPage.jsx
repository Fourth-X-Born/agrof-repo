    ...
    return (
        <div className="relative flex h-auto min-h-screen w-full flex-col font-display bg-background-light text-[#131613]">
            ...
            <main className="flex-grow">
                <div className="max-w-[1200px] mx-auto w-full px-6 py-10 animate-fade-in-up">
                    {/* Page Header */}
                    <div className="text-center mb-10 animate-fade-in-down">
                        <h1 className="text-3xl md:text-4xl font-bold text-[#131613]">Contact Us</h1>
                    ...
                    <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl p-4 mb-8 text-white shadow-lg animate-fade-in-down">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-primary rounded-xl p-4 text-white">
                                ...
                                <Link 
                                    to="/register"
                                    className="block w-full py-2 bg-white text-primary text-xs font-medium rounded-lg hover:bg-white/90 transition-all text-center"
                                >
                                    Get Started Free
                                </Link>
                            </div>
                    ...
                    {/* Map Section */}
                    <div className="mt-8 bg-white rounded-xl border border-gray-100 shadow-sm p-4 animate-fade-in-up">
